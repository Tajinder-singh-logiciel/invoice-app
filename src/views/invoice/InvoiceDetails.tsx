...
const InvoiceDetails: React.FC<InvoiceDetailsProps> = ({
  ...
  return (
    <div className="bg-main-bg min-h-screen p-4 md:p-8 text-white flex flex-col overflow-auto">
      <div
      ...
      <div className="bg-drawer-bg p-4 md:p-6 rounded-lg mb-4 md:mb-6 flex flex-col md:flex-row justify-between items-center">
        ...
        <div className="flex space-x-2 md:space-x-4">
          <button
            className="bg-blue-dark px-4 md:px-6 py-2 md:py-4 font-bold text-xs rounded-full"
            onClick={onEdit}
          >
            Edit
          </button>
